...
- Fork `Equinox.Cosmos` to `Equinox.CosmosStore`
    ...
    - Reorganized `QueryRetryPolicy` to handle `IAsyncEnumerable` coming in Cosmos SDK V4 [#245](https://github.com/jet/equinox/pull/225) :pray: [@ylibrach](https://github.com/ylibrach)
