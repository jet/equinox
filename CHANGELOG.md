...
- Standardise naming of top level structure: `<StoreName>Connection`, `*Context`, `*Category` [#276](https://github.com/jet/equinox/pull/276)
    - Rename `Resolver` -> `<StoreName>Category`
    - Rename `Connection` -> `<StoreName>Client`
