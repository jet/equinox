...
- `CosmosStore`: Replace the hard-coding in `Equinox.CosmosStore.Core.Initialization.initAux` with an input parameter [#328](https://github.com/jet/equinox/pull/328) :pray: [@brihadish](https://github.com/brihadish)
