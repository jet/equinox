...
type CachingStrategy =
    ...
    /// Unless <c>LoadOption.AnyCachedValue</c> or <c>MaxStaleness</c> are used, cache hits still incurs an etag-contingent Tip read (at a cost of a roundtrip with a 1RU charge if unmodified).
