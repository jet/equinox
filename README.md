...
- the Access Strategies
  ...
  a. define what we put in the `Tip`
  b. how we short circuit loading if we have a snapshot
  c. allows us to post-process the events we are writing as required for reasons of optimization
