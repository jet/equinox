...
- `Equinox.EventStore` [![EventStore NuGet](https://img.shields.io/nuget/v/Equinox.EventStore.svg)](https://www.nuget.org/packages/Equinox.EventStore/): Production-strength [EventStore](https://eventstore.org/) Adapter instrumented to the degree necessitated by Jet's production monitoring requirements. ([depends](https://www.fuget.org/packages/Equinox.EventStore) on `Equinox.Core`, `EventStore.Client >= 5.0.1`, `FSharp.Control.AsyncSeq`)
- `Equinox.EventStore.Grpc` [![EventStore.Grpc NuGet](https://img.shields.io/nuget/v/Equinox.EventStore.Grpc.svg)](https://www.nuget.org/packages/Equinox.EventStore.Grpc/): Production-strength [EventStore](https://eventstore.org/) Adapter instrumented to the degree necessitated by Jet's production monitoring requirements. ([depends](https://www.fuget.org/packages/Equinox.EventStore) on `Equinox.Core`, `EventStore.Client.Grpc` >= `6.0.0-preview2`, `FSharp.Control.AsyncSeq` v `2.0.23`, EventStore Server version `20.03` or later)
